...
if(!r){const s=function(e,t,i,r=!1){const s=e._definitionCache,n=e.store,l=e._potentialPolymorphicTypes,{type:d}=t
let h=a(s,d,i)
if(void 0!==h)return h
const u=n.schema.fields(t).get(i)
if(!u){if(l[d]){const e=Object.keys(l[d])
for(let t=0;t<e.length;t++){const r=a(s,e[t],i)
if(r)return c(s,d,i,r),r.rhs_modelNames.push(d),r}}return s[d][i]=null,null}const f=w(u)
let p,y
const g=f.type
if(null===f.inverseKey?p=null:(y=function(e,t,i){const r=e.schema.fields(t).get(i)
return r?r.options.inverse:null}(o(n),t,i),p=!y&&f.isPolymorphic&&f.inverseKey?{kind:"belongsTo",key:f.inverseKey,type:d,isAsync:!1,isImplicit:!1,isCollection:!1,isPolymorphic:!1}:y?w(n.schema.fields({type:g}).get(y)):null),!p){y=v(d,i),p={kind:"implicit",key:y,type:d,isAsync:!1,isImplicit:!0,isCollection:!0,isPolymorphic:!1},R(f,p),R(p,f)
const e={lhs_key:`${d}:${i}`,lhs_modelNames:[d],lhs_baseModelName:d,lhs_relationshipName:i,lhs_definition:f,lhs_isPolymorphic:f.isPolymorphic,rhs_key:p.key,rhs_modelNames:[g],rhs_baseModelName:g,rhs_relationshipName:p.key,rhs_definition:p,rhs_isPolymorphic:!1,hasInverse:!1,isSelfReferential:d===g,isReflexive:!1}
return c(s,g,y,e),c(s,d,i,e),e}const m=p.type
if(h=a(s,m,i)||a(s,g,y),h)return(h.lhs_baseModelName===m?h.lhs_modelNames:h.rhs_modelNames).push(d),c(s,d,i,h),h
R(f,p),R(p,f)
const _=[d]
d!==m&&_.push(m)
const b=m===g,k={lhs_key:`${m}:${i}`,lhs_modelNames:_,lhs_baseModelName:m,lhs_relationshipName:i,lhs_definition:f,lhs_isPolymorphic:f.isPolymorphic,rhs_key:`${g}:${y}`,rhs_modelNames:[g],rhs_baseModelName:g,rhs_relationshipName:y,rhs_definition:p,rhs_isPolymorphic:p.isPolymorphic,hasInverse:!0,isSelfReferential:b,isReflexive:b&&i===y}
return c(s,m,i,k),c(s,d,i,k),c(s,g,y,k),k}(this,e,t)
...
class C{constructor(e){var t,i;(function(e,t,i){(function(e,t){if(t.has(e))throw new TypeError("Cannot initialize the same private elements twice on an object")})(e,t),t.set(e,void 0)})(this,A),this.id=e.requestId,i=e,(t=A).set(o(t,this),i),this.request=e.enhancedRequest}setStream(e){n(A,this).setStream(e)}setResponse(e){n(A,this).setResponse(e)}get hasRequestedStream(){return n(A,this).hasRequestedStream}}new Map([["records","array"],["data","json"],["body",{type:"string",klass:["Blob","ArrayBuffer","TypedArray","DataView","FormData","URLSearchParams","ReadableStream"]}],["disableTestWaiter","boolean"],["options","object"],["cacheOptions","object"],["op","string"],["store","object"],["url","string"],["cache",["default","force-cache","no-cache","no-store","only-if-cached","reload"]],["credentials",["include","omit","same-origin"]],["destination",["","object","audio","audioworklet","document","embed","font","frame","iframe","image","manifest","paintworklet","report","script","sharedworker","style","track","video","worker","xslt"]],["headers","headers"],["integrity","string"],["keepalive","boolean"],["method",["GET","PUT","PATCH","DELETE","POST","OPTIONS"]],["mode",["same-origin","cors","navigate","no-cors"]],["redirect",["error","follow","manual"]],["referrer","string"],["signal","AbortSignal"],["controller","AbortController"],["referrerPolicy",["","same-origin","no-referrer","no-referrer-when-downgrade","origin","origin-when-cross-origin","strict-origin","strict-origin-when-cross-origin","unsafe-url"]]]),(0,r.L1)("IS_FROZEN",Symbol("FROZEN")),(0,r.L1)("IS_COLLECTION",Symbol.for("Collection")),new Set([])},82:(e,t,i)=>{i.d(t,{Ay:()=>a,ud:()=>s.b})
var r=i(375),s=i(632)
...
const{relationships:a}=e,c=function(e,t,i,r){const{name:s}=i,{type:n}=t,o=function(e,t,i){const r=e.schema.fields(t).get(i)
return r?r.options.inverse:null}(e,{type:n},s)
if(o)return{inverseKey:o,kind:e.schema.fields({type:r}).get(o).kind}}(i,t,r,o)
if(c){const{inverseKey:e,kind:i}=c,r=a[e]?.data
...
var o}}
function gt(e,t,i){return(t=function(e){var t=function(e,t){if("object"!=typeof e||!e)return e
var i=e[Symbol.toPrimitive]
if(void 0!==i){var r=i.call(e,"string")
if("object"!=typeof r)return r
throw new TypeError("@@toPrimitive must return a primitive value.")}return String(e)}(e)
